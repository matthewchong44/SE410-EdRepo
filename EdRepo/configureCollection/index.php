      ...
      <?php
        if(!isset($userInformation)) {
          ...
          echo '<h1>Configure '.$COLLECTION_NAME.'</h1>';
           ...
           echo '<h3>Configure Header & Footer</h3>';
		   echo '<p>Change the content and display settings of this collection\'s header and footer.</p>';
           echo '<p><a class="button" href="configureHeader.php">Configure Header</a><a class="button" href="configureFooter.php">Configure Footer</a></p>';
           echo '</div><br>';
          ...
          if(in_array("UseCategories", $backendCapabilities["read"]) && in_array("UseCategories", $backendCapabilities["write"])) {
            echo '<div class="subblock">';
            echo '<h3>Collection Categories</h3>';
            ...
            echo 'collection</p>';
            echo '<p><a href="configureCategories.php" class="button">Configure Categories</a></p>';
            echo '</div><br>';
          }
          
          /* Display block allowing us to configure static pages (about page, home page, etc) */
           echo '<div class="subblock">';
           echo '<h3>Information Pages</h3>';
           ...
           echo '</select>';
           echo '<input type="submit" class="button" name="sub" value="Edit Page"></input>';
           echo '</div>';
          }
      ?>
