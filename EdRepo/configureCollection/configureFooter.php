        ...
        if(!isset($userInformation)) {
          ...
          if($action=="displayEdit") {
            if($pagename===FALSE) { //A $pagename of FALSE means the page given to edit isn't valid, or no page was given to edit.
              ...
              echo '<form name="editStaticContentForm" method="post" action="configureFooter.php">';
			  ...
			  if ($FOOTER_SHOW_NAME==TRUE) { echo ' checked="checked"'; }
			  echo ' /> Show collection name: <strong>'.$COLLECTION_NAME.'</strong><br>';
			  echo '<input type="checkbox" name="links" value="TRUE"';
			  if ($FOOTER_SHOW_LINKS==TRUE) { echo ' checked="checked"'; }
			  echo ' /> Show menu links.';
			  echo '</p>';
...
$FOOTER_SHOW_NAME='.$set['name'].';

/* Show menu links in footer */
$FOOTER_SHOW_LINKS='.$set['links'].';
