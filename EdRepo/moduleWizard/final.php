...
<?php
  ...
  function displayNavigationFooter($moduleID, $moduleAction) {
    ...
    if($NEW_MODULES_REQUIRE_MODERATION==TRUE) {
      echo '<input type="submit" class="button" name="submitForModeration" value="Submit For Moderation" onclick="return changeFormActionToSubmit();"></input>';
    } else {
      echo '<input type="submit" class="button" name="submit" value="Publish To Collection" onclick="return changeFormActionToSubmit();"></input>';
    }
    echo '</form>';
  }
