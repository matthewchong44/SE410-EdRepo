...
<?php
  ...
  function displayNavigationFooter($moduleID, $moduleAction) {
    ...
    echo '<input type="submit" class="button" name="delete" value="Delete This Module" disabled="disabled" onclick="return changeFormActionToDelete();"></input>';
    echo '<input type="submit" class="button" name="back" value="Back" disabled="disabled" onclick="return changeFormActionToBack();"></input>';
    echo '<input type="submit" class="button" name="next" value="Next" onclick="return changeFormActionToNext();"></input>';
    echo '<input type="submit" class="button" name="save" value="Save Progress" disabled="disabled" onclick="return changeFormActionToSave();"></input>';
