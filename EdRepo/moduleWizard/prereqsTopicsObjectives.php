    ...
    <div id="mainContentArea">
      ...
      <?php
        if(!isset($userInformation)) {
          ...
          if($moduleAction=="edit") {
            echo '<h1>Module Topics, Categories, Objectives, and Prerequisites</h1>';
            ...
            if($moduleAction=="edit") {
              ...
              if(in_array("UseCategories", $backendCapabilities["write"]) && in_array("UseCategories", $backendCapabilities["write"])) { //Only display category options if the backend supports it
                echo '<tr><td class="MIEVCategoryCell"><span class="MIEVCategoryText">Categories</span></td>';
                 echo '<td><div id="categoryList"></div><button type="button" class="button" onclick="addCategory(false);">Add Category</td></tr>';
              }
              echo '<tr><td class="MIEVCategoryCell"><span class="MIEVCategoryText">Topics</span></td>';
               echo '<td><div id="topicsList"></div><button type="button" class="button" onclick="add(\'Topics\', false);">Add Topic</button></td></tr>';
              echo '<tr><td class="MIEVCategoryCell"><span class="MIEVCategoryText">Objectives</span></td>';
               echo '<td><div id="objectivesList"></div><button type="button" class="button" onclick="add(\'Objectives\', false);">Add Objective</button></td></tr>';
              echo '<tr><td class="MIEVCategoryCell"><span class="MIEVCategoryText">Prerequisites</span></td>';
               echo '<td><div id="prereqsList"></div><button type="button" class="button" onclick="add(\'Prereqs\', false);">Add Prerequisite</button></td></tr>';
              echo '</table>';
