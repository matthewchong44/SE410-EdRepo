        ...
        if(!isset($userInformation)) {
          ...
          if($moduleAction=="edit") {
            ...
            if($moduleAction=="edit") {
              ...
              echo '</table>';
              echo '<input type="submit" class="button" name="submit" value="Submit Module"></input></form><br>';
          ...
          if($moduleAction=="doSubmit") {
            if(!isset($_REQUEST["moduleCheckInComments"])) {
              ...
              if(submitModule($_REQUEST, $userInformation, $moduleInfo, $_REQUEST["moduleCheckInComments"], $NEW_MODULES_REQUIRE_MODERATION)===TRUE) {
                ...
                echo '<p class="alert positive"><img src="../lib/look/'.$LOOK_DIR.'/success.png" alt="Success"></img> ';
                if($NEW_MODULES_REQUIRE_MODERATION==TRUE) {
                  echo 'Your module has been successfully submitted for moderation.</p>';
                  ...
                  echo 'Your module has been successfully published to the collection.</p>';
                }
              } else { //Module submission failed :(
                echo '<h1>Module Submission Failed</h1>';
                echo '<p class="alert negative"><img src="../lib/look/'.$LOOK_DIR.'/failure.png" alt="Failure"></img> ';
                echo '<span class="error">Module submission failed.</span></p>';
