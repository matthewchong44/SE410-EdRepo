      ...
      <?php
        if(!isset($userInformation)) {
          ...
          if($stage=="introduction") {
            ...
            echo '<p>Creating a Resource consists of three straightforward steps: entering basic information about the Resource, cross-referencing the Resource with ';
            echo 'other related Resources, documents, and sources, and attatching materials to your Resources.  Each material you attatch to your Resource, ';
            ...
            echo '<p>These steps are broken down into several screens to simplify the Resource creation process.  Your progress is saved each time you ';
            echo 'move to a different screen or click "Save Progress".  However, your Resource will not be ';
          ...
          echo '<p>To create or edit Resources, you must have a higher privilege level.  Contact the collection maintainer for more information.</p>';
        }
      ?>
